...
const
  ...
  security1 = 'https://i.imgur.com/yPJuUIC.png';
const slides = [


  {
    id: 1,
    name: "2010 Ford Taurus Freelancer",
    desc: "Acceleration:Okay / Brakes:Okay / Handling:Good ➡ (Security Coordinator - Security Guard)",
    color: "#FFFFFF",
  ...
  return /*#__PURE__*/ (
    React.createElement("div", {
      ...
      React.createElement("h1", {
        ...
        React.createElement("span", null, "Security:"), /*#__PURE__*/
...
class Slider extends React.Component {
  ...
  componentDidMount() {
    ...
    if (window.location.href.indexOf("?=FordTaurusFreelancer") > -1) {
