...
const
  ...
  ems1 = 'https://i.imgur.com/WKbY4JW.png';
ems2 = 'https://i.imgur.com/43IcSB2.png';
ems3 = 'https://i.imgur.com/dni5pGe.png';
ems4 = 'https://i.imgur.com/onOJRUH.png';
...
const slides = [
...

  {
    ...
    desc: "★ Premium Only ★ Acceleration:Bad / Brakes:Good / Handling:Okay ➡ (E.M.S Director)",
    color: "#FFC300",
  ...
  {
    id: 2,
    name: "Monolith Medical Response Unit",
    desc: "Acceleration:Okay / Brakes:Okay / Handling:Okay ➡ (E.M.S Director - Paramedic)",
    color: "#FFFFFF",
    imgFloorUrl: floorImg,
    imgUrl: ems2,
    topSpeed: 100,
  ...
  {
    id: 3,
    name: "Dodge Charger SRT8 2012 EMS",
    desc: "Acceleration:Okay / Brakes:Okay / Handling:Good ➡ (E.M.S Director)",
    color: "#FFFFFF",
    imgFloorUrl: floorImg,
    imgUrl: ems3,
    topSpeed: 100,
  ...
  {
    id: 4,
    name: "2010 Ford F350 Ambulance",
    desc: "Acceleration:Good / Brakes:Okay / Handling:Good ➡ (E.M.S Director - Paramedic)",
    color: "#FFFFFF",
    imgFloorUrl: floorImg,
    imgUrl: ems4,
    topSpeed: 90,
  ...
  return /*#__PURE__*/ (
    React.createElement("div", {
      ...
      React.createElement("h1", {
        ...
        React.createElement("span", null, "EMS:"), /*#__PURE__*/
...
class Slider extends React.Component {
  ...
  componentDidMount() {
    ...
    if (window.location.href.indexOf("?=2020FordExplorer") > -1) {
      this.setActiveSlide(this.state.activeSlide + 0);

    }

    if (window.location.href.indexOf("?=MMRU") > -1) {
      this.setActiveSlide(this.state.activeSlide + 1);

    }

    if (window.location.href.indexOf("?=DodgeCSRT82012EMS") > -1) {
      this.setActiveSlide(this.state.activeSlide + 2);

    }

    if (window.location.href.indexOf("?=F350Ambulance") > -1) {
