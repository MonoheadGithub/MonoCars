...
const
  ...
  garbageman1 = 'https://i.imgur.com/JkpJXLM.png';
const slides = [
...

  {
    id: 1,
    name: "Garbage Truck",
    desc: "Acceleration:Bad / Brakes:Good / Handling:Good ➡ (Garbage Man)",
    color: "#FFFFFF",
  ...
  return /*#__PURE__*/ (
    React.createElement("div", {
      ...
      React.createElement("h1", {
        ...
        React.createElement("span", null, "GarbageMan:"), /*#__PURE__*/
...
class Slider extends React.Component {
  ...
  componentDidMount() {
    ...
    if (window.location.href.indexOf("?=GarbageTruck") > -1) {
