...
const
  ...
  bitedriver1 = 'https://i.imgur.com/olWVjiu.png';
const slides = [
...

  {
    id: 1,
    name: "Bite Truck",
    desc: "Acceleration:Bad / Brakes:Okay / Handling:Okay ➡ (Food Truck Driver)",
    color: "#FFFFFF",
  ...
  return /*#__PURE__*/ (
    React.createElement("div", {
      ...
      React.createElement("h1", {
        ...
        React.createElement("span", null, "Bite Driver:"), /*#__PURE__*/
...
class Slider extends React.Component {
  ...
  componentDidMount() {
    ...
    if (window.location.href.indexOf("?=BiteTruck") > -1) {
