...
const
  ...
  suv1 = 'https://i.imgur.com/QGxkDAg.png';
suv2 = 'https://i.imgur.com/h1v8cTZ.png';
suv3 = 'https://i.imgur.com/TaZQpzU.png';
suv4 = 'https://i.imgur.com/6RHjcWe.png';
suv5 = 'https://i.imgur.com/j3nwlvJ.png';
suv6 = 'https://i.imgur.com/8j14JYp.png';
suv7 = 'https://i.imgur.com/5hnmucv.png';
suv8 = 'https://i.imgur.com/DXV9H9r.png';
suv9 = 'https://i.imgur.com/bpyHUm0.png';
suv10 = 'https://i.imgur.com/Rc27mdH.png';
const slides = [
...

  {
    ...
    desc: "★ Premium Only ★ Acceleration:Okay / Brakes:Okay / Handling:Good",
    color: "#FFC300",
  ...
  {
    id: 2,
    name: "2006 Porsche Cayenne Turbo Sport",
  ...
  {
    id: 6,
    name: "2015 GMC Savana",
    desc: "Acceleration:Bad / Breaks:Good / Handling:Good",
    color: "#FFFFFF",
    imgFloorUrl: floorImg,
    imgUrl: suv7,
    topSpeed: 75,
  ...
  return /*#__PURE__*/ (
    React.createElement("div", {
      ...
      React.createElement("h1", {
        ...
        React.createElement("span", null, "SUV:"), /*#__PURE__*/
...
class Slider extends React.Component {
  ...
  componentDidMount() {
    ...
    if (window.location.href.indexOf("?=2015PorscheCayenneTurbo") > -1) {
      this.setActiveSlide(this.state.activeSlide + 0);

    }

    if (window.location.href.indexOf("?=2006PorscheCayenneTurboSport") > -1) {
      this.setActiveSlide(this.state.activeSlide + 1);

    }

    if (window.location.href.indexOf("?=2012FordTransit") > -1) {
      this.setActiveSlide(this.state.activeSlide + 2);

    }

    if (window.location.href.indexOf("?=2012LandRoverRangeRoverSupercharged") > -1) {
      this.setActiveSlide(this.state.activeSlide + 3);

    }

    if (window.location.href.indexOf("?=1998VolvoXC70Turbo") > -1) {
      this.setActiveSlide(this.state.activeSlide + 4);

    }

    if (window.location.href.indexOf("?=2015GMCSavana") > -1) {
      this.setActiveSlide(this.state.activeSlide + 5);

    }

    if (window.location.href.indexOf("?=2005VolvoXC90") > -1) {
      this.setActiveSlide(this.state.activeSlide + 6);

    }

    if (window.location.href.indexOf("?=2014ToyotaFJCruiser") > -1) {
      this.setActiveSlide(this.state.activeSlide + 7);

    }

    if (window.location.href.indexOf("?=2012ToyotaRAV4Sport") > -1) {
      this.setActiveSlide(this.state.activeSlide + 8);

    }

    if (window.location.href.indexOf("?=1983LandRoverDefender") > -1) {
