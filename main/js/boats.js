...
const
  ...
  bo1 = 'https://i.imgur.com/K0L82bx.png';
bo2 = 'https://i.imgur.com/CEFde5A.png';
bo3 = 'https://i.imgur.com/N8NzBHe.png';
  ...
  return /*#__PURE__*/ (
    React.createElement("div", {
      ...
      React.createElement("h1", {
        ...
        React.createElement("span", null, "Boats:"), /*#__PURE__*/
...
class Slider extends React.Component {
  ...
  componentDidMount() {
    ...
    if (window.location.href.indexOf("?=Jetski") > -1) {
      this.setActiveSlide(this.state.activeSlide + 0);

    }

    if (window.location.href.indexOf("?=RHIB") > -1) {
      this.setActiveSlide(this.state.activeSlide + 1);

    }

    if (window.location.href.indexOf("?=Yacht") > -1) {
