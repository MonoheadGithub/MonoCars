...
const
  ...
  mechanic1 = 'https://i.imgur.com/278XWXe.png';
mechanic2 = 'https://i.imgur.com/RcZZDmG.png';
...
const slides = [
...

  {
    id: 1,
    name: "2010 Ford F350",
    desc: "Acceleration:Bad / Brakes:Okay / Handling:Good ➡ (Towing Manager)",
    color: "#FFFFFF",
...

  {
    id: 2,
    name: "Tow Truck",
    desc: "Acceleration:Bad / Brakes:Okay / Handling:Okay ➡ (Towing Manager - Tow Truck Driver)",
    color: "#FFFFFF",
    imgFloorUrl: floorImg,
    imgUrl: mechanic2,
    topSpeed: 60,
  ...
  return /*#__PURE__*/ (
    React.createElement("div", {
      ...
      React.createElement("h1", {
        ...
        React.createElement("span", null, "Mechanic:"), /*#__PURE__*/
...
class Slider extends React.Component {
  ...
  componentDidMount() {
    ...
    if (window.location.href.indexOf("?=2010FordF350") > -1) {
      this.setActiveSlide(this.state.activeSlide + 0);

    }

    if (window.location.href.indexOf("?=TowTruck") > -1) {
      this.setActiveSlide(this.state.activeSlide + 1);
