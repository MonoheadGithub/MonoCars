...
const
  ...
  ss1 = 'https://i.imgur.com/ejv3TO4.png';
ss2 = 'https://i.imgur.com/Tjr0oac.png';
...
const slides = [
  ...
  {
    id: 1,
    name: "2013 Chevrolet Tahoe SS",
    desc: "Acceleration:Okay / Brakes:Okay / Handling:Good ➡ (Secret Service)",
    color: "#FFFFFF",
  ...
  {
    id: 2,
    name: "2005 Cadillac DTS Limousine",
    desc: "Acceleration:Okay / Brakes:Okay / Handling:Good ➡ (Mayor)",
    color: "#FFFFFF",
    imgFloorUrl: floorImg,
    imgUrl: ss2,
    topSpeed: 60,
  ...
  return /*#__PURE__*/ (
    React.createElement("div", {
      ...
      React.createElement("h1", {
        ...
        React.createElement("span", null, "SS:"), /*#__PURE__*/
...
class Slider extends React.Component {
  ...
  componentDidMount() {
    ...
    if (window.location.href.indexOf("?=ChevroletTahoeSS") > -1) {
      this.setActiveSlide(this.state.activeSlide + 0);

    }

    if (window.location.href.indexOf("?=Mayor") > -1) {
      this.setActiveSlide(this.state.activeSlide + 1);
