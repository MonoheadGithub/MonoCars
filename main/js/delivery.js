...
const
  ...
  delivery1 = 'https://i.imgur.com/JdZTpkN.png';
const slides = [
...

  {
    id: 1,
    name: "Courier Truck",
    desc: "Acceleration:Bad / Brakes:Good / Handling:Good ➡ (Delivery Driver)",
    color: "#FFFFFF",
  ...
  return /*#__PURE__*/ (
    React.createElement("div", {
      ...
      React.createElement("h1", {
        ...
        React.createElement("span", null, "Delivery:"), /*#__PURE__*/
...
class Slider extends React.Component {
  ...
  componentDidMount() {
    ...
    if (window.location.href.indexOf("?=CourierTruck") > -1) {
