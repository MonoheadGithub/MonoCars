...
const
  ...
  pine1 = 'https://i.imgur.com/btqdKFH.png';
pine2 = 'https://i.imgur.com/NHSngPZ.png';
pine3 = 'https://i.imgur.com/ZFxk4W7.png';
const slides = [


  {
    id: 1,
    name: "2006 Chevrolet Tahoe",
    desc: "Acceleration:Bad / Brakes:Okay / Handling:Good  ➡ (Pine County Deputy)",
    color: "#FFFFFF",
  ...
  {
    id: 2,
    name: "1982 Ford Bronco XLT",
    desc: "Acceleration:Good / Brakes:Okay / Handling:Good ➡ (Pine County Deputy)",
    color: "#FFFFFF",
    imgFloorUrl: floorImg,
    imgUrl: pine2,
    topSpeed: 100,
...

  {
    ...
    desc: "★ Premium Only ★ Acceleration:Okay / Brakes:Good / Handling:Good ➡ (Pine County Deputy)",
    color: "#FFC300",
    imgFloorUrl: floorImg,
    imgUrl: pine3,
    topSpeed: 90,
  ...
  return /*#__PURE__*/ (
    React.createElement("div", {
      ...
      React.createElement("h1", {
        ...
        React.createElement("span", null, "PineCounty:"), /*#__PURE__*/
...
class Slider extends React.Component {
  ...
  componentDidMount() {
    ...
    if (window.location.href.indexOf("?=2006ChevroletTahoe") > -1) {
      this.setActiveSlide(this.state.activeSlide + 0);

    }

    if (window.location.href.indexOf("?=1982FordBroncoXLT") > -1) {
      this.setActiveSlide(this.state.activeSlide + 1);

    }

    if (window.location.href.indexOf("?=2011FordCrownVictoria") > -1) {
