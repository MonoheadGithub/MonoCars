...
const
  ...
  fd1 = 'https://i.imgur.com/3wrPAiO.png';
fd2 = 'https://i.imgur.com/SKQczLi.png';
fd3 = 'https://i.imgur.com/82uxlSm.png';
const slides = [
...

  {
    ...
    desc: "Acceleration:Bad / Brakes:Okay / Handling:Good ➡ (Fire Chief)",
    color: "#FFFFFF",
...

  {
    ...
    desc: "★ Premium Only ★ Acceleration:Bad / Brakes:Good / Handling:Good ➡ (Fire Chief)",
    color: "#FFC300",
    imgFloorUrl: floorImg,
    imgUrl: fd2,
    topSpeed: 120,
...

  {
    id: 3,
    name: "Fire Truck",
    desc: "Acceleration:Bad / Brakes:Okay / Handling:Okay ➡ (Fire Chief - Firefighter)",
    color: "#FFFFFF",
    imgFloorUrl: floorImg,
    imgUrl: fd3,
    topSpeed: 100,
  ...
  return /*#__PURE__*/ (
    React.createElement("div", {
      ...
      React.createElement("h1", {
        ...
        React.createElement("span", null, "FD:"), /*#__PURE__*/
...
class Slider extends React.Component {
  ...
  componentDidMount() {
    ...
    if (window.location.href.indexOf("?=FireTruck") > -1) {
